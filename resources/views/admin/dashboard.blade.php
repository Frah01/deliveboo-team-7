...
@section('content')
    ...
    <div class="bg-animated">
       ...
       <div class="container-cards d-flex justify-content-center position-absolute z-3">
           @if (Auth::user()->id == 1)
           <div class="row">
               <div class="col-4">
                   <div class="card-dashboard">
                    <img src="https://cdn-icons-png.flaticon.com/128/3081/3081139.png" alt="">
                    <h2 class="titolo-card">Ristoranti </h2>
                    <p>Da qui potrai visualizzare la lista di tutti i ristoranti</p>
                    <a href="{{route('admin.restaurants.index') }}">
                        <button class="bottone-cards">Visualizza ristoranti</button>
                       </a>
                   </div>
               </div>
               <div class="col-4">
                   <div class="card-dashboard" >
                    <img src="https://cdn-icons-png.flaticon.com/128/5162/5162724.png" alt="">
                    <h2 class="titolo-card">Piatti </h2>
                    <p>Scegli tra centinaia di piatti diversi e mangia ciò che preferisci!</p>
                       <a href="{{route('admin.dishes.index') }}">
                        <button class="bottone-cards">Visualizza piatti</button>
                       </a>
                   </div>
               </div>
               <div class="col-4">
                   <div class="card-dashboard" >
                    ...
                    <h2 class="titolo-card">Categorie </h2>
                    <p>Qui potrai visualizzare tutte le categorie di ristoranti presenti nel nostro sito</p>
                       <a href="{{route('admin.categories.index') }}">
                        <button class="bottone-cards">Visualizza categorie</button>
                       </a>
                   </div>
               </div>
           ...
           <div class="row">
              <div class="informazioni-ristorante">
                    <div>
                        <h1>Benvenuto nella homepage del tuo locale, <span class="primary-color">{{Auth::user()->name}}!</span></h1>
               ...
               <div class="col-6">
                   <div class="card-dashboard" >
                       ...
                       <p>Da qui potrai accedere al menù del tuo ristorante ed aggiungere tutti i piatti che vorrai!</p>
                       <a href="{{route('admin.restaurants.show', $slug) }}">
                        <button class="bottone-cards">Visualizza menù</button>
                       </a>
                   </div>
               </div>
               <div class="col-6">
